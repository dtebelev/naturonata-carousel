...
> **Версия:** v5.14 (30 июля 2026)
> **Файл программы:** `app.py` (~1596 строк)
...
*Файл для передачи новому агенту. v5.14 от 30 июля 2026 — можно менять размер акцентной строки и подписи @канала на каждой карточке.*
