...
> **Версия:** v5.9 (30 июля 2026)
> **Файл программы:** `app.py` (~1440 строк)
...
*Файл для передачи новому агенту. v5.9 от 30 июля 2026 — CTA гарантирован на последней карточке, верхний счётчик скрыт на первой и последней, старые превью пересобираются автоматически.*
